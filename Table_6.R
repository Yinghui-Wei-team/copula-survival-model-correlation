...
table_6 <- data.frame(rho, copula, 
                      lambda1_MAE, lambda1_CP, 
                      lambda2_MAE, lambda2_CP, 
                      rho_MAE, rho_CP, 
                      Normal_perc, Clayton_perc, Frank_perc, Gumbel_perc)

true_lambda1 <- 0.023              #hazard rate of kidney failure
true_lambda2 <- 0.025              #hazard rate of death
...
#save
table_6$lambda1_MAE[1] <- bias_lambda1
table_6$lambda1_CP[1] <- coverage_lambda1
table_6$lambda2_MAE[1] <- bias_lambda2
table_6$lambda2_CP[1] <- coverage_lambda2
table_6$rho_MAE[1] <- bias_rho
table_6$rho_CP[1] <- coverage_rho
table_6$Normal_perc[1] <- percent_normal
table_6$Clayton_perc[1] <- percent_clayton
table_6$Frank_perc[1] <- percent_frank
table_6$Gumbel_perc[1] <- percent_gumbel
...
#save
table_6$lambda1_MAE[2] <- bias_lambda1
table_6$lambda1_CP[2] <- coverage_lambda1
table_6$lambda2_MAE[2] <- bias_lambda2
table_6$lambda2_CP[2] <- coverage_lambda2
table_6$rho_MAE[2] <- bias_rho
table_6$rho_CP[2] <- coverage_rho
table_6$Normal_perc[2] <- percent_normal
table_6$Clayton_perc[2] <- percent_clayton
table_6$Frank_perc[2] <- percent_frank
table_6$Gumbel_perc[2] <- percent_gumbel
...
#save
table_6$lambda1_MAE[3] <- bias_lambda1
table_6$lambda1_CP[3] <- coverage_lambda1
table_6$lambda2_MAE[3] <- bias_lambda2
table_6$lambda2_CP[3] <- coverage_lambda2
table_6$rho_MAE[3] <- bias_rho
table_6$rho_CP[3] <- coverage_rho
table_6$Normal_perc[3] <- percent_normal
table_6$Clayton_perc[3] <- percent_clayton
table_6$Frank_perc[3] <- percent_frank
table_6$Gumbel_perc[3] <- percent_gumbel
...
#save
table_6$lambda1_MAE[4] <- bias_lambda1
table_6$lambda1_CP[4] <- coverage_lambda1
table_6$lambda2_MAE[4] <- bias_lambda2
table_6$lambda2_CP[4] <- coverage_lambda2
table_6$rho_MAE[4] <- bias_rho
table_6$rho_CP[4] <- coverage_rho
table_6$Normal_perc[4] <- percent_normal
table_6$Clayton_perc[4] <- percent_clayton
table_6$Frank_perc[4] <- percent_frank
table_6$Gumbel_perc[4] <- percent_gumbel
...
#save
table_6$lambda1_MAE[5] <- bias_lambda1
table_6$lambda1_CP[5] <- coverage_lambda1
table_6$lambda2_MAE[5] <- bias_lambda2
table_6$lambda2_CP[5] <- coverage_lambda2
table_6$rho_MAE[5] <- bias_rho
table_6$rho_CP[5] <- coverage_rho
table_6$Normal_perc[5] <- percent_normal
table_6$Clayton_perc[5] <- percent_clayton
table_6$Frank_perc[5] <- percent_frank
table_6$Gumbel_perc[5] <- percent_gumbel
...
#save
table_6$lambda1_MAE[6] <- bias_lambda1
table_6$lambda1_CP[6] <- coverage_lambda1
table_6$lambda2_MAE[6] <- bias_lambda2
table_6$lambda2_CP[6] <- coverage_lambda2
table_6$rho_MAE[6] <- bias_rho
table_6$rho_CP[6] <- coverage_rho
table_6$Normal_perc[6] <- percent_normal
table_6$Clayton_perc[6] <- percent_clayton
table_6$Frank_perc[6] <- percent_frank
table_6$Gumbel_perc[6] <- percent_gumbel
...
for(i in 1:(runs)){
  ...
  #Optimise with all copula models
  normal_optim <- optim(c(0.1,0.1,0.1), normal_loglik, method="L-BFGS-B",lower=c(0.01,0.01,0.01),upper=c(0.1,0.1,0.99), X=df$X,Y=df$Y,d1=df$d1,d2=df$d2,control=list(fnscale=-1),hessian=TRUE)
  normal_estimated_params <- c(normal_optim$par[1], normal_optim$par[2],normal_optim$par[3]) 
...
#save
table_6$lambda1_MAE[7] <- bias_lambda1
table_6$lambda1_CP[7] <- coverage_lambda1
table_6$lambda2_MAE[7] <- bias_lambda2
table_6$lambda2_CP[7] <- coverage_lambda2
table_6$rho_MAE[7] <- bias_rho
table_6$rho_CP[7] <- coverage_rho
table_6$Normal_perc[7] <- percent_normal
table_6$Clayton_perc[7] <- percent_clayton
table_6$Frank_perc[7] <- percent_frank
table_6$Gumbel_perc[7] <- percent_gumbel
...
#save
table_6$lambda1_MAE[8] <- bias_lambda1
table_6$lambda1_CP[8] <- coverage_lambda1
table_6$lambda2_MAE[8] <- bias_lambda2
table_6$lambda2_CP[8] <- coverage_lambda2
table_6$rho_MAE[8] <- bias_rho
table_6$rho_CP[8] <- coverage_rho
table_6$Normal_perc[8] <- percent_normal
table_6$Clayton_perc[8] <- percent_clayton
table_6$Frank_perc[8] <- percent_frank
table_6$Gumbel_perc[8] <- percent_gumbel
...
#choose 
set.seed(36535)
true_lambda1 <- 0.023                   #kidney failure
true_lambda2 <- 0.025                   #death
true_theta <- 1.54
copula_gumbel <- gumbelCopula(true_theta) #convert theta to rho
true_rho <- rho(copula_gumbel)
...
for(i in 1:(runs)){
  ...
  u1 <- runif(n,0,1)      
  gumbel_copula <- gumbelCopula(true_theta, dim=2)
  uv <- cCopula(cbind(u1, runif(n)), copula = gumbel_copula, inverse = TRUE) 
  u <- uv[,1]  #split u and v from the results of cdm
  v <- uv[,2]
  T1 <- -log(u)/true_lambda1 
  T2 <- -log(v)/true_lambda2  
  C<-runif(n,0,50) 
  X<-pmin(T1,T2,C)
  Y<-pmin(T2, C) 
  d1<-ifelse(T1<=Y,1,0) 
  ...
  if (i==862|i==969){
    normal_optim <- optim(c(0.1,0.1,0.1), normal_loglik_sim, method="L-BFGS-B",lower=c(0.01,0.01,0.01),upper=c(0.2,0.2,0.99), X=df$X,Y=df$Y,d1=df$d1,d2=df$d2,control=list(fnscale=-1),hessian=TRUE)
    normal_estimated_params <- c(normal_optim$par[1], normal_optim$par[2],normal_optim$par[3]) 
  }
  else{
    normal_optim <- optim(c(0.1,0.1,0.1), normal_loglik, method="L-BFGS-B",lower=c(0.01,0.01,0.01),upper=c(0.2,0.2,0.99), X=df$X,Y=df$Y,d1=df$d1,d2=df$d2,control=list(fnscale=-1),hessian=TRUE)
  ...
  loglik_gumbel <- gumbel_loglik(gumbel_estimated_params,X=df$X,Y=df$Y,d1=df$d1,d2=df$d2)      
  loglik_frank <- frank_loglik(frank_estimated_params,X=df$X,Y=df$Y,d1=df$d1,d2=df$d2)      
  loglik_clayton <- clayton_loglik(clayton_estimated_params,X=df$X,Y=df$Y,d1=df$d1,d2=df$d2)     
  loglik_normal <- normal_loglik(normal_estimated_params,X=df$X,Y=df$Y,d1=df$d1,d2=df$d2)                           
  
  k <- 3                                                          #3 parameters: l1,l2,theta  
  aicg <- -2*loglik_gumbel + 2*k                                        #aic for gumbel 
  aicf <- -2*loglik_frank + 2*k                                        #aic for frank
  aicc <- -2*loglik_clayton + 2*k                                        #aic for clayton
  aicn <- -2*loglik_normal + 2*k                                        #aic for normal
  
  aics <- c(aicn, aicc, aicf, aicg)                                                #all AIC values
  cops <- c("Normal", "Clayton", "Frank","Gumbel") #Names of copulas (in order)
  ...
  #for boundries of Clayton
  #any ci below minimum of copula package bounds
  if (index==2){
    if (lowerci3 < -1) {counterless=counterless+1}
    if (lowerci3 < -1) {lowerci3=-1} 
  }
...
#save
table_6$lambda1_MAE[9] <- bias_lambda1
table_6$lambda1_CP[9] <- coverage_lambda1
table_6$lambda2_MAE[9] <- bias_lambda2
table_6$lambda2_CP[9] <- coverage_lambda2
table_6$rho_MAE[9] <- bias_rho
table_6$rho_CP[9] <- coverage_rho
table_6$Normal_perc[9] <- percent_normal
table_6$Clayton_perc[9] <- percent_clayton
table_6$Frank_perc[9] <- percent_frank
table_6$Gumbel_perc[9] <- percent_gumbel
...
#save
table_6$lambda1_MAE[10] <- bias_lambda1
table_6$lambda1_CP[10] <- coverage_lambda1
table_6$lambda2_MAE[10] <- bias_lambda2
table_6$lambda2_CP[10] <- coverage_lambda2
table_6$rho_MAE[10] <- bias_rho
table_6$rho_CP[10] <- coverage_rho
table_6$Normal_perc[10] <- percent_normal
table_6$Clayton_perc[10] <- percent_clayton
table_6$Frank_perc[10] <- percent_frank
table_6$Gumbel_perc[10] <- percent_gumbel
...
#save
table_6$lambda1_MAE[11] <- bias_lambda1
table_6$lambda1_CP[11] <- coverage_lambda1
table_6$lambda2_MAE[11] <- bias_lambda2
table_6$lambda2_CP[11] <- coverage_lambda2
table_6$rho_MAE[11] <- bias_rho
table_6$rho_CP[11] <- coverage_rho
table_6$Normal_perc[11] <- percent_normal
table_6$Clayton_perc[11] <- percent_clayton
table_6$Frank_perc[11] <- percent_frank
table_6$Gumbel_perc[11] <- percent_gumbel
...
#save
table_6$lambda1_MAE[12] <- bias_lambda1
table_6$lambda1_CP[12] <- coverage_lambda1
table_6$lambda2_MAE[12] <- bias_lambda2
table_6$lambda2_CP[12] <- coverage_lambda2
table_6$rho_MAE[12] <- bias_rho
table_6$rho_CP[12] <- coverage_rho
table_6$Normal_perc[12] <- percent_normal
table_6$Clayton_perc[12] <- percent_clayton
table_6$Frank_perc[12] <- percent_frank
table_6$Gumbel_perc[12] <- percent_gumbel
...
#save
table_6$lambda1_MAE[13] <- bias_lambda1
table_6$lambda1_CP[13] <- coverage_lambda1
table_6$lambda2_MAE[13] <- bias_lambda2
table_6$lambda2_CP[13] <- coverage_lambda2
table_6$rho_MAE[13] <- bias_rho
table_6$rho_CP[13] <- coverage_rho
table_6$Normal_perc[13] <- percent_normal
table_6$Clayton_perc[13] <- percent_clayton
table_6$Frank_perc[13] <- percent_frank
table_6$Gumbel_perc[13] <- percent_gumbel
...
#save
table_6$lambda1_MAE[14] <- bias_lambda1
table_6$lambda1_CP[14] <- coverage_lambda1
table_6$lambda2_MAE[14] <- bias_lambda2
table_6$lambda2_CP[14] <- coverage_lambda2
table_6$rho_MAE[14] <- bias_rho
table_6$rho_CP[14] <- coverage_rho
table_6$Normal_perc[14] <- percent_normal
table_6$Clayton_perc[14] <- percent_clayton
table_6$Frank_perc[14] <- percent_frank
table_6$Gumbel_perc[14] <- percent_gumbel
...
#save
table_6$lambda1_MAE[15] <- bias_lambda1
table_6$lambda1_CP[15] <- coverage_lambda1
table_6$lambda2_MAE[15] <- bias_lambda2
table_6$lambda2_CP[15] <- coverage_lambda2
table_6$rho_MAE[15] <- bias_rho
table_6$rho_CP[15] <- coverage_rho
table_6$Normal_perc[15] <- percent_normal
table_6$Clayton_perc[15] <- percent_clayton
table_6$Frank_perc[15] <- percent_frank
table_6$Gumbel_perc[15] <- percent_gumbel
...
#save
table_6$lambda1_MAE[16] <- bias_lambda1
table_6$lambda1_CP[16] <- coverage_lambda1
table_6$lambda2_MAE[16] <- bias_lambda2
table_6$lambda2_CP[16] <- coverage_lambda2
table_6$rho_MAE[16] <- bias_rho
table_6$rho_CP[16] <- coverage_rho
table_6$Normal_perc[16] <- percent_normal
table_6$Clayton_perc[16] <- percent_clayton
table_6$Frank_perc[16] <- percent_frank
table_6$Gumbel_perc[16] <- percent_gumbel
...
for(i in 1:(runs)){
  ...
  else{normal_optim <- optim(c(0.1,0.1,0.1), normal_loglik, method="L-BFGS-B",lower=c(0.01,0.01,0.01),upper=c(0.2,0.2,0.99), X=df$X,Y=df$Y,d1=df$d1,d2=df$d2,control=list(fnscale=-1),hessian=TRUE)
  normal_estimated_params <- c(normal_optim$par[1], normal_optim$par[2],normal_optim$par[3]) 
  }
  clayton_optim <- optim(c(0.1,0.1,0.4), clayton_loglik, method="L-BFGS-B",lower=c(0.01,0.01,0.01),upper=c(0.2,0.2,20), X=df$X, Y=df$Y, d1=df$d1, d2=df$d2, control=list(fnscale=-1), hessian=TRUE)
  clayton_estimated_params <- c(clayton_optim$par[1], clayton_optim$par[2],clayton_optim$par[3]) 
...
#save
table_6$lambda1_MAE[17] <- bias_lambda1
table_6$lambda1_CP[17] <- coverage_lambda1
table_6$lambda2_MAE[17] <- bias_lambda2
table_6$lambda2_CP[17] <- coverage_lambda2
table_6$rho_MAE[17] <- bias_rho
table_6$rho_CP[17] <- coverage_rho
table_6$Normal_perc[17] <- percent_normal
table_6$Clayton_perc[17] <- percent_clayton
table_6$Frank_perc[17] <- percent_frank
table_6$Gumbel_perc[17] <- percent_gumbel